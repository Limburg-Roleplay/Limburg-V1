...
Citizen.CreateThread(function()
    while true do
        ...
        for gangName, gangData in pairs(Config.Wapeninkoopgangs) do
            if gangData[1] and (
                (ESX.PlayerData.job and ESX.PlayerData.job.name == gangData[1].gangname and ESX.PlayerData.job.grade >= gangData[1].mingrade) or
                (ESX.PlayerData.job2 and ESX.PlayerData.job2.name == gangData[1].gangname and ESX.PlayerData.job2.grade >= gangData[1].mingrade)
                ) then
