...
RegisterNetEvent('jtm:createRefund')
AddEventHandler('jtm:createRefund', function(source, steamID, item, itemCount)
    -- Jouw eigen refund functie, #refunds om het direct te laten werken ;)
end)
